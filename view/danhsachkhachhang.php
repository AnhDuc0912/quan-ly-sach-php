                            ...
                            <div class="card-body">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="../controller/khachhang.php" method="post">
                                                        ...
                                                        <div
                                                            ...
                                                            <input type="submit" class="btn btn-primary" name="uploadclick" value="Tạo">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <?php
                                    $sql = "SELECT * FROM khachhang INNER JOIN nhomkhachhang ON khachhang.id_nhomkh = nhomkhachhang.id GROUP BY khachhang.id";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['id_nhomkh']?></td>
                                                <td><?php echo $row['diachi']?></td>

                                            
                                                <td><a href="suakhachhang.php?idkh=<?php echo $row[0]?>" class="btn btn-secondary">Sửa</a>
                                                 <a onclick="return confirm('Xác Nhận Xóa ?')" href="../controller/xoakhachhang.php?idkh=<?php echo $row[0]?>" class="btn btn-danger">Xóa</a></td>
                                                 <td><a href="createdon.php?id=<?php echo $row[0]?>" class="btn btn-success">Tạo đơn hàng</a></td>
                                            </tr>
                                            <?php 
                                        }
                                    }
