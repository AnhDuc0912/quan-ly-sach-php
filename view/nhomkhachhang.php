...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Nhóm Khách Hàng</h6>
        </div>
        <div class="card-body">
            <div class="form-row">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header border-bottom-0">
                                    <h5 class="modal-title" id="exampleModalLabel">Tạo Mới Nhóm Khách Hàng</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form action="../controller/themmoinhomkh.php" method="post">
                                    <div class="modal-body">
                                        
                                        <div class="form-group">
                                            <label for="">Nhóm Khách Hàng</label>
                                            <input type="text" class="form-control" name="nhomkh">
                                        </div>
                                    ...
                                    <div class="modal-footer border-top-1 d-flex justify-content-center">
                                        <button type="submit" name="themmoinhomkh" class="btn btn-primary">Tạo</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="suanhomkh.php?id=<?php echo $row['id']; ?>"
                                                                        name="suanhomkh" class="btn btn-secondary">Sửa</a>
                                                                    <a onclick="return confirm('Xác Nhận Xóa ?')"
                                                                        href="../controller/xoanhomkh.php?id=<?php echo $row['id']; ?>"
