                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            if (isset($_GET['idkh']) && $_GET['idkh']) {
                                $id = $_GET['idkh'];
                                $sqlselectdata_tbl_khachhang = "SELECT * FROM `khachhang` WHERE id = $id";
                                $sqlselectdata_tbl_nhomkhachhang = "SELECT * FROM `nhomkhachhang`";

                                $result_tbl_khachhang = mysqli_query($conn, $sqlselectdata_tbl_khachhang);
                                $result_tbl_nhomkhachhang = mysqli_query($conn, $sqlselectdata_tbl_nhomkhachhang);

                                $row_tbl_khachhang = mysqli_fetch_assoc($result_tbl_khachhang);
                                // $row_tbl_nhomkhachhang = mysqli_fetch_assoc($result_tbl_nhomkhachhang);
                            } else {
                                header("location: listsach.php");
                            }

                            ?>
                            <form action="../controller/suakh.php?idkh=<?php echo $row_tbl_khachhang['id'] ?>" method="POST">
                                <div class="form-group">
                                    <div class="form-group">
                                        <div class="form-group col-md-12">
                                            <label for="">Tên Khách Hàng:</label>
                                            <input type="text" class="form-control" id="" required
                                                value="<?php echo $row_tbl_khachhang['name']; ?>" placeholder="Enter Name"
                                                name="namekh">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="inputState">Thể Loại</label>
                                        <select name="nhomkh" class="form-control">
                                            <?php
                                            if (mysqli_num_rows($result_tbl_nhomkhachhang) > 0) {
                                                while ($row_tbl_nhomkhachhang = mysqli_fetch_array($result_tbl_nhomkhachhang)) {
                                                    ?>
                                                    <option value="<?php echo $row_tbl_nhomkhachhang['id'] ?>">
                                                        <?php echo $row_tbl_nhomkhachhang['name_kh'] ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group col-md-12">
                                            <label for="">SĐT: </label>
                                            <input type="number" class="form-control" id="" placeholder="Enter Name"
                                                value="<?php echo $row_tbl_khachhang['sdt']; ?>" name="sdt">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Name"
                                            value="<?php echo $row_tbl_khachhang['diachi']; ?>" name="diachi">
                                    </div>
                                </div>
                                <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <input type="submit" class="btn btn-primary" name="suakh" value="Cập Nhập Khách Hàng">
                        </div>
                        </form>
