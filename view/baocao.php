            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <?php
                        ...
                        $sql = "SELECT DATE(hd.date) AS ngay, 
                                SUM(hd.gia - s.gia * hd.soluong) AS profit,
                                s.gia AS gia_goc,
                                hd.gia AS gia_ban,
                                hd.soluong,
                                s.name
                                FROM hoadon hd 
                                LEFT JOIN sach s ON hd.id_sach = s.id 
                                WHERE MONTH(hd.date) = $month - 1 AND YEAR(hd.date) = $year
                                GROUP BY DATE(hd.date), s.name, s.gia, hd.gia, hd.soluong";
                        ...
                        // Gọi hàm để tạo và lưu báo cáo vào thư mục
                        generateProfitReport($month - 1, $year, $data, $totalProfit);
                    
                    ?>

                     <div class="text-center">
                        <iframe width="800" height="500" src="./resource/profit_report_prev_month.pdf" frameborder="0"></iframe>
                    </div>
                </div>
                <!-- Footer -->
