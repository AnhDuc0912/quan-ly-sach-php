                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                            ...
                            <form action="upload.php" method="POST">
                                <div class="form-group">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter the name" name="tenkh">
                                    </div>
                                </div>

                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="inputState">Nhóm Khách Hàng</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="sdt" placeholder="SDT">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group col-md-12">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label for="inputState">Chọn Tỉnh/Thành Phố</label>
                                        <select id="inputState" class="form-control">
                                            <option selected></option>
                                            <option>...</option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="inputState">Chọn Phường/Xã</label>
                                        <select id="inputState" class="form-control">
                                            <option selected></option>
                                            <option>...</option>
                                        </select>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="form-group">
                                <div class="form-group col-md-12">
                                    <label for="inputState">Tên Sách</label>
                                    <select id="inputState" class="form-control" name="tensach">
                            ...
                            <div class="form-group">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="n" class="form-control" id="" aria-describedby="emailHelp"
                                        placeholder="Enter Name">
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" placeholder="Description 1.." id="floatingTextarea2"
                                        style="height: 100px"></textarea>
                                </div>
                            </div>

                            <div class="form-group col-md-3">
                                <input type="submit" class="btn btn-primary" name="submit" value="Tạo Đơn Hàng">
                                </form>
